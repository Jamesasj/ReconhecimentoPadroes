...
MAKECMD         = /export/thomas/R2012a/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL              = tev5sim
MODULES            = rtGetInf.c rtGetNaN.c rt_nonfinite.c tev5sim_acc_data.c 
MAKEFILE           = tev5sim.mk
MATLAB_ROOT        = /export/thomas/R2012a
ALT_MATLAB_ROOT    = /export/thomas/R2012a
MASTER_ANCHOR_DIR  = 
START_DIR          = /export/thomas/prognosticsDatasets/Tennessee_Eastman/TEmatlab
S_FUNCTIONS        = tesfunc.c
S_FUNCTIONS_LIB    = 
SOLVER             = ode1.c
NUMST              = 2
TID01EQ            = 1
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/tev5sim \
	-I$(START_DIR) \
